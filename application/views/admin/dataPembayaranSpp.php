...
<div class="container-fluid" style="height: 100vh;">
    ...
    <!-- Page Heading -->
    <form action="<?php echo base_url('reRegistrationPayment') ?>" method="post">
        <div class="row">
        ...
        <table class="table table-sm table-hover table-bordered">
            <thead>
                <tr style="text-transform: uppercase; font-size: 13px; background: #ececec;">
                    ...
                    <th style="width:120px; text-align: center;">Pembayaran</th>
                    <th style="width:170px; text-align: right;">Jumlah &nbsp;</th>
