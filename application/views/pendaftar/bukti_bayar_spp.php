...
$qry_byr = $this->db->get_where('transaksi', ['nik' => $user['nik'], 'kode_spp' => $bulan]);
...
<div class="container-fluid">
    ...
    <?php if ($user['gambar'] != '') { ?>
        <div class="col-md-10 card roounded p-3 mb-3">
            <form action="<?= base_url('send_trx_spp') ?>" method="POST" enctype="multipart/form-data">
                <strong class="row alert alert-danger px-3 mx-3 mt-2">Kirimkan Bukti Pembayaran SPP</strong>
